...
export default function Complete() {
  return (
    <section className="w-full h-[460px] max-sm:h-[518px] max-sm:relative max-sm:mb-[40px] bg-[url('/photo-1505935428862-770b6f24f629.avif')] bg-no-repeat bg-cover bg-center flex items-center">
      <div className="max-w-lg mx-auto flex flex-col items-center text-[#3F5D45]">
        ...
        <NavLink
          to="/product"
          className="inline-block max-sm:absolute max-sm:top-[100%] max-sm:w-full text-[24px] py-[16px] px-[100px] text-center bg-[#FFE180] text-[#3F5D45] font-medium"
        >
          繼續逛逛
        </NavLink>
      </div>
